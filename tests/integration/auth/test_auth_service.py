...
async def test_google_auth__login_not_exist_user(auth_service):
    code = "fake_code"
...
async def test_google_auth__login_exist_user(auth_service):
...
async def test_base_login__success(auth_service):
